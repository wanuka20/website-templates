    ...
    <footer className="bg-zinc-950 py-12 text-white">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="min-w-0">
            <p className="mb-4 text-sm font-semibold uppercase tracking-wider text-white/70">Menu</p>
          ...
          <div className="min-w-0">
            <p className="mb-4 text-sm font-semibold uppercase tracking-wider text-white/70">Visit Us</p>
            <div className="space-y-2 text-sm text-white/60">
              <p>{config.address}, {config.city}</p>
              <p>{config.phone}</p>
              <p className="break-words">{config.email}</p>
            </div>
          </div>
        </div>
