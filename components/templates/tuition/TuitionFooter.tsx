    ...
    <footer className="bg-blue-950 py-12 text-white">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            <p className="mb-4 text-sm font-semibold uppercase tracking-wider text-blue-100">Subjects</p>
          ...
          <div>
            <p className="mb-4 text-sm font-semibold uppercase tracking-wider text-blue-100">Contact</p>
        ...
        <div className="mt-8 border-t border-blue-700 pt-8 text-center text-xs text-blue-100">
