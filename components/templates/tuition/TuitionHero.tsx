  ...
  return (
    <section id="hero" className="relative flex min-h-screen items-center overflow-hidden">
      <div className="absolute inset-0">
        <Image src={config.heroImage} alt="Academy" fill priority sizes="100vw" className="object-cover" />
      ...
      <div className="relative container mx-auto max-w-7xl px-4 py-32 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <div className="hero-reveal hero-delay-4 mt-14 grid grid-cols-2 gap-4 border-t border-white/20 pt-8 sm:grid-cols-4">
