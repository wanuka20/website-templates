...
import { resolveRealEstateDesign, type RealEstateDesign } from "@/config/realestate-design";
...
export default async function RealEstateTemplatePage() {
  ...
  const RealEstateTemplate =
    realEstateTemplates[resolveRealEstateDesign(realestateConfig.themeTemplate)];
